...
const KennelItem = ({ _id, name, displayPicture, location }: KennelItemProps) => {
  return (
    <Link href={`/kennels/${_id}`} passHref>
      <Box overflow='hidden' cursor='pointer' width='100%' bgColor='white' shadow='xs' rounded='lg' py='4' px='4' _hover={{ md: { shadow: "lg" } }}>
        ...
        <Text textAlign='center' isTruncated fontWeight='semibold' fontSize={{ base: "xs", sm: "sm" }} mt='3'>
          {name}
        </Text>
